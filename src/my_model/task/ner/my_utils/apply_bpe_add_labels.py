...
class BPE(object):
    ...
    def process_line(self, line,labels):
        ...
        if leading_whitespace:
            ...
            out_labels += line[:leading_whitespace]

        line_out, labels_out = self.segment(line,labels)
        out += line_out
        ...
        if trailing_whitespace and trailing_whitespace != len(line):
            ...
            out_labels += line[-trailing_whitespace:]


        return out,out_labels

    def segment(self, sentence, labels):
        """segment single sentence (whitespace-tokenized string) with BPE encoding"""
        segments,segments_labels = self.segment_tokens(sentence.strip('\r\n ').split(' '),labels.strip('\r\n ').split(' '))
        return ' '.join(segments),' '.join(segments_labels)


    def segment_tokens(self, tokens, labels):
...
#    print('args:',args)
#    #print('args.codes.names:' ,args.codes.names)
